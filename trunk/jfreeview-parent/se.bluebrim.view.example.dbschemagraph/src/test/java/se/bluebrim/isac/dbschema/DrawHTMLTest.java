...
public class DrawHTMLTest
{
	...
	private class HTMLPanel extends JPanel
	{
		...
		{
			super.paint(g);
			drawTextView((Graphics2D) g, htmlView, new DoubleInsets(0, 0 ,0, 0));
		}
		
		private void drawTextView(Graphics2D g, javax.swing.text.View htmlView, DoubleInsets textInsets)
		{
